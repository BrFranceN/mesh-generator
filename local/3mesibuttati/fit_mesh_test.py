...
if __name__ == '__main__':
    ...
    DATA_DIR = "../dataset/dataset/77c2f1b7a7c0a4d15ca1f314f1afc186/" 
...
'''
CREATE DATASET 
(TO TRANFORM IN A FILE)
'''
# root_directory = 'dataset/dataset-mini/'
# id2ti = dict()
...
#                 # TODO TEXTURE
#                 textures.append(elem)
#                 #HOW BEHAVE WITH MORE THAN ONE TEXTURE?
#         elif str(subdir) == 'models':
#             for elem in os.listdir(directory_path+'/'+str(subdir)):
#                 # TODO MODELS
#                 models.append(elem)
#     id2ti[str(directory)] = (textures,models)

# print(id2ti)

# for key,value in id2ti.items():
#     print(f'key ->{key}',end='')
#     print(f', value -> {value}')
